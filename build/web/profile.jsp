...
<body>
    <%
        ...
        if(rs.next()){
            out.println("<div class='menu-bar'>");
            out.println("<ul>");
            out.println("<li><a href='user.html'>Home</a></li>");
            out.println("<li><a href='profile.jsp'>Profile</a></li>");
            out.println("<li><a href='accountdetails.jsp'>Account Details</a></li>");
            out.println("<li><a href='transfermoney.jsp'>Transfer Money</a></li>");
            out.println("<li><a href='transactionhistory.jsp'>Transaction History</a></li>");
